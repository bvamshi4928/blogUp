...
import { HiTag, HiCalendar, HiSortAscending, HiSortDescending } from 'react-icons/hi';
...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const hasSearchParams = searchTermFromUrl || categoryFromUrl !== 'uncategorized' || urlParams.has('sort');
    ...
    const fetchPosts = async () => {
      ...
      try {
        const apiUrl = `/api/post/getposts${searchQuery ? `?${searchQuery}` : '?sort=desc'}`;
          ...
          <main className='flex-1 min-w-0'>
            ...
            {loading && (
              <div className='flex flex-col items-center justify-center py-20'>
                ...
                <p className='text-lg text-gray-600 dark:text-gray-400'>Searching articles...</p>
              </div>
            )}
