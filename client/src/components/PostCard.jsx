...
export default function PostCard({ post }) {
  ...
  return (
    <div className="group relative w-full h-full overflow-hidden rounded-2xl bg-white dark:bg-slate-800 shadow-lg hover:shadow-xl border border-gray-200 dark:border-slate-700">
      ...
      <div className="p-5 flex flex-col gap-3 h-[calc(100%-12rem)]">
        ...
        <div className="flex items-center gap-3 py-2 border-t border-gray-200 dark:border-slate-700">
